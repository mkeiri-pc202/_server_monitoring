...
- JavascriptとCSSがわからないとWebアプリは作成できない（結局よくわからなかったので仕事で使うなら要勉強。授業で詳しく聞けたら嬉しかったかもしれない
- SQLAlcemeyの利点はif文で分岐させたときの表記の少なさなのかな\
  メソッドから条件を追加していけるのがうれしい
- madplotlibを使うのに時間がかかると思ったほうがよい\
...
- 一番時間がかかったのはグラフをHTMLに表示させる箇所\
  いろいろコピペしてたら動いた\
  画像を一度バイナリに変換してそれを返す必要があるのだが、プログラムを見てもおまじないにしか見えない
---
